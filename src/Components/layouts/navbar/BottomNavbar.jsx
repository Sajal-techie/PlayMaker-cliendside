...
const BottomNavbar = () => {
    const color = 'text-gblue-400 group-hover:text-white'
    const hovercolor = 'hover:bg-gblue-400 '
  return (
    <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-300  sm:hidden">
        <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
            <Link to={'/home'} className={`${hovercolor} inline-flex flex-col items-center justify-center px-5   group`}>
            ...
            <button type="button" className={`${hovercolor}inline-flex flex-col items-center justify-center px-5   group`}>
                ...
                <span className="text-sm text-gray-700   ">Trials</span>
            </button>
            <button type="button" className={`${hovercolor}inline-flex flex-col items-center justify-center px-5   group`}>
