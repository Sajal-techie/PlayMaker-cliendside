...
const Dropdown = ({options,label,onChange,role,value}) => {
  ...
  return (
    <>
        ...
        <select value={value} id={`${label}`} name={label} className='border-2 border-slate-300  py-2 px-4 w-80 rounded-md text-sm outline-none  font-extralight' onChange={onChange}>
